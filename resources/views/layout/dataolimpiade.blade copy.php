    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Data Peserta SEA GAMES</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Data Peserta SEA GAMES</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Olimpiade Yang Di Ikuti</th>
                    ...
                    <tbody class="table-group-divider">
                        ...
                        <tr>
                            ...
                            <td>{{ $row->negara }}</td>
                            <td>
                                <img src="{{ asset('fotopeserta/'.$row->foto) }}" alt="" style="width: 80px;">
                            </td>
                            <td>
